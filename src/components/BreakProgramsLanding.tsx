...
import { ChevronLeft, ThumbsUp, DollarSign, PlayCircle, Zap, Calendar, Shield, ArrowRight } from "lucide-react";
...
export default function BreakProgramsLanding({ onBack, onStartProgram }: Props) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      <section className="relative min-h-[80vh] flex items-center pt-24 pb-12 px-6 overflow-hidden">
        <div className="absolute inset-0 z-0 flex">
          <div className="w-1/2 h-full relative">
            <img 
              src="https://images.unsplash.com/photo-1517963879466-e1b54ebd6694?q=80&w=1000&auto=format&fit=crop" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 mb-6">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-accent">Elite Break Protocols</span>
            </div>
            ...
            <p className="text-xl text-white/60 mb-10 leading-relaxed max-w-2xl">
              Elite off-season protocols designed to maintain and build performance during school breaks. Don't lose your gains—keep pushing, keep growing.
            </p>
