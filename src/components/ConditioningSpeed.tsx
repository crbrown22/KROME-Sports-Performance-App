...
import { ChevronLeft, ThumbsUp, DollarSign, PlayCircle, Zap, Timer, Activity, Shield, ArrowRight } from "lucide-react";
...
export default function ConditioningSpeed({ onBack, onStartProgram }: Props) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-black uppercase italic tracking-tighter mb-6 leading-none">
              Speed, Agility & <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold to-accent pr-2 pb-2">Conditioning</span>
            </h1>
            <p className="text-xl text-white/60 mb-10 leading-relaxed max-w-2xl">
              Improve takeoff, acceleration, and top speed for better performance. Train in optimal heart rate zones to maximize efficiency and dominate the competition.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Speed Kills",
                desc: "Improve takeoff, acceleration, and top speed for better performance.",
                icon: <Zap className="w-8 h-8" />
              },
              {
                title: "Stay in the Zone",
                desc: "Train in optimal heart rate zones to maximize efficiency.",
                icon: <Activity className="w-8 h-8" />
              },
              {
                title: "Change Direction",
                desc: "Enhance agility and power for quick directional changes.",
      ...
      <section className="py-24 bg-zinc-950 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              ...
              <h3 className="text-4xl md:text-6xl font-black uppercase italic leading-tight">
                Benefits of Speed, <br />Agility & Conditioning
              </h3>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: "Enhanced Quickness", desc: "Target sudden stops and starts to improve reaction times." },
              { title: "Increased VO2 Max", desc: "Boost endurance for sustained high-level performance." },
              { title: "Better Coordination", desc: "Drills build coordination, balance, and strength, reducing injuries." }
            ].map((perk, idx) => (
