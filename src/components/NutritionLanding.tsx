...
import { ChevronLeft, ThumbsUp, DollarSign, PlayCircle, Zap, Utensils, Shield, ArrowRight } from "lucide-react";
...
export default function NutritionLanding({ onBack, onStartProgram }: Props) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 mb-6">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-accent">Elite Fueling Protocol</span>
            </div>
            <h1 className="text-6xl md:text-8xl font-black uppercase italic tracking-tighter mb-6 leading-none">
              Nutrition <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold to-accent pr-2 pb-2">Optimization</span>
            </h1>
            <p className="text-xl text-white/60 mb-10 leading-relaxed max-w-2xl">
              Fuel your performance with precision. Optimize your macro and micronutrient intake to accelerate recovery, boost energy, and achieve your peak physical state.
            </p>
